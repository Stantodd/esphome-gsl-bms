...
void SeplosBms::on_telemetry_data_(const std::vector<uint8_t> &data) {
  ...
  // ->
  // 0x11004600F07A0001100CF30CF00CEE0CE90CF50CF80CF80CF90CEE0CE80CF90CF40CF90CF80CF70CFA060B1E0B220B210B1E0B1C0B3201F2CF833818036D6000E66D60E209  Seplos ????
  ...
  this->publish_state_(this->state_of_health_sensor_, (float) seplos_get_16bit(offset + 15));

  // if (data.size() < offset + 17 + 2) {
  //  return;
  //  }

  //   71     0x14 0x9F      Checksum ?                     5279 * 0.01f = 52.79          V
